...
<div class="mb-3">
  ...
  <input type="number" v-model="count"class="form-control"  :class="{'is-invalid':!count}"id="number" >
  <div class="invalid-feedback">
...
<div class="mb-3">
  ...
  <input type="number" v-model="price"class="form-control" :class="{'is-invalid':!price}" id="number">
  <div class="invalid-feedback">
